...
(function() {
  var addAttributes, extractNode, isArray, isObject, isString, kidomi, makeElementFromTagData, parseTagToken;
  ...
  kidomi.addAttributes = addAttributes = function(elem, data) {
    var classString, name, styleItems, styleString, val, _results;
    if (data.style != null) {
    ...
    for (name in data) {
      ...
      if (name !== 'class' && name !== 'style') {
        _results.push(elem.setAttribute(name, val));
      } else {
